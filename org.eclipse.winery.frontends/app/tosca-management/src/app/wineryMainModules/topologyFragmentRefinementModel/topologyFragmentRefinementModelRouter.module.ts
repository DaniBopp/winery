...
const topologyFragmentRefinementRoutes: Routes = [
...
@NgModule({
    imports: [
        RouterModule.forChild(topologyFragmentRefinementRoutes),
    ],
    exports: [
        RouterModule,
    ],
...
export class TopologyFragmentRefinementModelRouterModule {
}
